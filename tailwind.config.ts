...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 1px 2px -1px rgb(15 23 42 / 0.08), 0 2px 8px -2px rgb(15 23 42 / 0.06)",
        card: "0 1px 3px rgb(15 23 42 / 0.04), 0 8px 24px -6px rgb(15 23 42 / 0.08)",
        lift: "0 2px 4px rgb(15 23 42 / 0.04), 0 16px 40px -12px rgb(15 23 42 / 0.16)",
