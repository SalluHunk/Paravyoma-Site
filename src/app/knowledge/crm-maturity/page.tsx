...
const config = getKnowledgeCenter("crm-maturity");

export const metadata: Metadata = {
  title: "CRM Maturity Knowledge Center",
  description: config.description,
  alternates: {
    canonical: `${siteConfig.url}/knowledge/crm-maturity`,
  },
  openGraph: {
    title: `CRM Maturity Knowledge Center — ${siteConfig.name}`,
    description: config.description,
    url: `${siteConfig.url}/knowledge/crm-maturity`,
  },
};

export default function CrmMaturityKnowledgeCenterPage() {
