...
export const metadata: Metadata = {
  title: "Temple Operations Knowledge Center",
  description: config.description,
  alternates: {
    canonical: `${siteConfig.url}/knowledge/temple-operations`,
  },
  openGraph: {
    title: `Temple Operations Knowledge Center — ${siteConfig.name}`,
    description: config.description,
    url: `${siteConfig.url}/knowledge/temple-operations`,
  },
};

export default function TempleOperationsKnowledgeCenterPage() {
